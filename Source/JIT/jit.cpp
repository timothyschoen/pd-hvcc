...
template class llvm::cfg::Update<llvm::BasicBlock *>;
...
const char *clang_JitOutputObjectFile(void *ctx, const char *name)
{
    ...
    std::error_code ec;
    llvm::raw_fd_ostream dest(name, ec, llvm::sys::fs::OpenFlags::OF_None /*llvm::sys::fs::F_None*/);
    if (ec) {
    ...
    auto fileType = llvm::CodeGenFileType::CGFT_ObjectFile /*llvm::TargetMachine::CGFT_ObjectFile*/;
...
void *clang_JitIrCompile(void *ctx, const char *source, int type, error_handler_t handler)
{
    ...
    clang::CompilerInvocation::CreateFromArgs(compilerInvocation,
        llvm::ArrayRef<char const *>{itemcstrs.data(), itemcstrs.data() + itemcstrs.size()}, *diagnosticsEngine.get());
...
void *clang_JitIrOptimize(void *ctx)
{
    ...
    // optimizations.
    // TODO: use codeGenOptions.DebugPassManager as in original code
    // https://github.com/Kray-G/clang-jit
...
#pragma comment(lib, "clang/lib/LLVMBitstreamReader.lib")
#pragma comment(lib, "clang/lib/LLVMBitWriter.lib")
#pragma comment(lib, "clang/lib/LLVMCFGuard.lib")
...
#pragma comment(lib, "clang/lib/LLVMDebugInfoDWARF.lib")
#pragma comment(lib, "clang/lib/LLVMDemangle.lib")
#pragma comment(lib, "clang/lib/LLVMDWARFLinker.lib")
#pragma comment(lib, "clang/lib/LLVMExecutionEngine.lib")
#pragma comment(lib, "clang/lib/LLVMFrontendOpenMP.lib")
...
#pragma comment(lib, "clang/lib/LLVMRemarks.lib")
...
#pragma comment(lib, "clang/lib/LLVMTextAPI.lib")
